...
export function LanguageSelectorDropdown() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            isMobile ? "h-9 w-9 p-0" : "w-[140px] justify-between",
          )}
          onClick={handleClick}
        >
          <span className="flex items-center justify-center">
            ...
            {!isMobile && (
              <>
                ...
                <span className="ml-2 inline sm:hidden">{currentLanguage.code.toUpperCase()}</span>
      ...
      <PopoverContent className={isMobile ? "w-[180px] p-0" : "w-[140px] p-0"} onClick={handleClick}>
        <Command>
            ...
            <CommandGroup>
              {languages.map((lang) => (
                <CommandItem
                  ...
                  value={lang.code}
                  onSelect={(value) => {
                    setLanguage(value as "fr" | "fon" | "en" | "es" | "pt")
                    setOpen(false)
                  }}
                >
