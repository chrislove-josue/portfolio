...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "packs.note": "Hébergement offert. Nom de domaine non inclus. Accompagnement à la mise en ligne inclus dans tous les packs.",
    "packs.hosting.title": "Hébergement",
    "packs.hosting.value": "Offert — Nom de domaine non inclus",
