...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "packs.delay": "Délai indicatif",
    "packs.price": "Prix indicatif",
    "packs.cta": "Demander un devis",
    "packs.disclaimer": "Prix indicatif, devis personnalisé sur demande.",
    ...
    "packs.basique.features.3": "Optimisation SEO de base",
    "packs.basique.features.4": "Hébergement & nom de domaine (accompagnement à la mise en ligne)",
    "packs.basique.features.5": "1 cycle de révisions inclus",
    "packs.basique.argument": "Une vitrine professionnelle, rapide et prête à convaincre vos premiers visiteurs.",
    "packs.standard.badge": "Pack Standard",
    ...
    "packs.standard.features.4": "Tableau de bord d'administration simple",
    "packs.standard.features.5": "SEO avancé",
    "packs.standard.features.6": "2 cycles de révisions inclus",
    "packs.standard.features.7": "Formation à l'utilisation",
    "packs.standard.argument": "Votre activité, en ligne, avec les outils pour la piloter vous-même.",
    "packs.premium.badge": "Pack Premium",
    ...
    "packs.premium.features.3": "Fonctionnalités avancées : authentification, paiements, tableaux de bord, automatisations",
    "packs.premium.features.4": "Architecture pensée pour la scalabilité et la performance",
    "packs.premium.features.5": "Accompagnement DevOps (déploiement, CI/CD, serveur)",
    "packs.premium.features.6": "Support post-lancement (durée à définir : 1 à 3 mois)",
...
"contact.send.message": "Nu bi ɖo dandan mɛ",
  ...
  en: {
   ...
   "about.resume": "Download Resume",
    ...
    "packs.delay": "Estimated timeline",
    "packs.price": "Indicative price",
    "packs.cta": "Request a quote",
    "packs.disclaimer": "Indicative prices, custom quote on request.",
    "packs.basique.badge": "Basic Pack",
    ...
    "packs.basique.delay": "5 to 10 days",
    "packs.basique.price": "75,000 – 150,000 FCFA",
    "packs.basique.features.count": "6",
    "packs.basique.features.0": "Showcase site with 1 to 5 pages (Home, About, Services, Contact...)",
    ...
    "packs.basique.features.4": "Hosting & domain name (go-live assistance)",
    "packs.basique.features.5": "1 revision cycle included",
    "packs.basique.argument": "A professional, fast showcase ready to convince your first visitors.",
    "packs.standard.badge": "Standard Pack",
    "packs.standard.name": "Business",
    ...
    "packs.standard.features.1": "Site up to 10 pages or e-commerce platform (catalog, cart, payment)",
    ...
    "packs.standard.features.4": "Simple admin dashboard",
    "packs.standard.features.5": "Advanced SEO (semantic structure, performance, indexing)",
    "packs.standard.features.6": "2 revision cycles included",
    "packs.standard.features.7": "Usage training (1 session)",
    "packs.standard.argument": "Your business online, with the tools to run it yourself.",
    "packs.premium.badge": "Premium Pack",
    ...
    "packs.premium.delay": "4 to 10 weeks (depending on complexity)",
    "packs.premium.price": "From 700,000 FCFA",
    "packs.premium.features.count": "9",
    ...
    "packs.premium.features.7": "Post-launch support (duration to define: 1 to 3 months)",
    "packs.premium.features.8": "Unlimited revisions during development",
...
"contact.send.message": "All fields are required.",
  ...
  es: {
    ...
    "packs.delay": "Plazo estimado",
    "packs.price": "Precio indicativo",
    "packs.cta": "Solicitar presupuesto",
    "packs.disclaimer": "Precios indicativos, presupuesto personalizado a petición.",
    "packs.basique.badge": "Paquete Básico",
    ...
    "packs.basique.delay": "5 a 10 días",
    "packs.basique.price": "75 000 – 150 000 FCFA",
    "packs.basique.features.count": "6",
    "packs.basique.features.0": "Sitio vitrina de 1 a 5 páginas (Inicio, Sobre mí, Servicios, Contacto...)",
    ...
    "packs.basique.features.4": "Alojamiento y dominio (acompañamiento para el lanzamiento)",
    "packs.basique.features.5": "1 ciclo de revisiones incluido",
    "packs.basique.argument": "Una vitrina profesional, rápida y lista para convencer a tus primeros visitantes.",
    "packs.standard.badge": "Paquete Estándar",
    ...
    "packs.standard.features.1": "Sitio hasta 10 páginas o plataforma e-commerce (catálogo, carrito, pago)",
    ...
    "packs.standard.features.4": "Panel de administración simple",
    "packs.standard.features.5": "SEO avanzado (estructura semántica, rendimiento, indexación)",
    "packs.standard.features.6": "2 ciclos de revisiones incluidos",
    "packs.standard.features.7": "Formación de uso (1 sesión)",
    "packs.standard.argument": "Tu actividad en línea, con las herramientas para dirigirla tú mismo.",
    "packs.premium.badge": "Paquete Premium",
    ...
    "packs.premium.delay": "4 a 10 semanas (según complejidad)",
    "packs.premium.price": "Desde 700 000 FCFA",
    "packs.premium.features.count": "9",
    ...
    "packs.premium.features.7": "Soporte post-lanzamiento (duración a definir: 1 a 3 meses)",
    "packs.premium.features.8": "Revisiones ilimitadas durante el desarrollo",
...
"contact.send.message": "Todos los campos son obligatorios.",
  ...
  pt: {
    ...
    "packs.delay": "Prazo estimado",
    "packs.price": "Preço indicativo",
    "packs.cta": "Solicitar orçamento",
    "packs.disclaimer": "Preços indicativos, orçamento personalizado sob consulta.",
    "packs.basique.badge": "Pacote Básico",
    "packs.basique.name": "Vitrine",
    "packs.basique.for": "Para autônomos, associações e pequenas estruturas que querem uma presença online profissional.",
    "packs.basique.delay": "5 a 10 dias",
    "packs.basique.price": "75 000 – 150 000 FCFA",
    "packs.basique.features.count": "6",
    "packs.basique.features.0": "Site vitrine de 1 a 5 páginas (Início, Sobre, Serviços, Contato...)",
    ...
    "packs.basique.features.4": "Hospedagem e domínio (acompanhamento para o lançamento)",
    "packs.basique.features.5": "1 ciclo de revisões incluído",
    "packs.basique.argument": "Uma vitrine profissional, rápida e pronta para convencer seus primeiros visitantes.",
    "packs.standard.badge": "Pacote Padrão",
    ...
    "packs.standard.features.1": "Site até 10 páginas ou plataforma e-commerce (catálogo, carrinho, pagamento)",
    ...
    "packs.standard.features.4": "Painel de administração simples",
    "packs.standard.features.5": "SEO avançado (estrutura semântica, desempenho, indexação)",
    "packs.standard.features.6": "2 ciclos de revisões incluídos",
    "packs.standard.features.7": "Treinamento de uso (1 sessão)",
    "packs.standard.argument": "Sua atividade online, com as ferramentas para gerenciá-la você mesmo.",
    "packs.premium.badge": "Pacote Premium",
    ...
    "packs.premium.delay": "4 a 10 semanas (conforme complexidade)",
    "packs.premium.price": "A partir de 700 000 FCFA",
    "packs.premium.features.count": "9",
    ...
    "packs.premium.features.7": "Suporte pós-lançamento (duração a definir: 1 a 3 meses)",
    "packs.premium.features.8": "Revisões ilimitadas durante o desenvolvimento",
