...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "packs.standard.price": "200 000 – 500 000 FCFA",
    "packs.standard.features.count": "8",
    "packs.standard.features.0": "Tout le contenu du Pack Basique",
    "packs.standard.features.1": "Site jusqu'à 10 pages ou plateforme e-commerce (catalogue, panier, paiement)",
    ...
    "packs.premium.features.7": "Support post-lancement (durée à définir : 1 à 3 mois)",
    "packs.premium.features.8": "Révisions illimitées pendant le développement",
