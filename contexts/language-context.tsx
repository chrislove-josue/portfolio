...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "packs.cta.message": "Bonjour, je suis intéressé(e) par le Pack {pack}. Pourriez-vous m'en dire plus ?",
...
"contact.send.message": "Nu bi ɖo dandan mɛ",
  ...
  en: {
   ...
   "about.resume": "Download Resume",
    ...
    "packs.cta.message": "Hello, I'm interested in the {pack} Pack. Could you tell me more?",
